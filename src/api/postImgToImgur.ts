...
// const accessToken = config.imgurId.accessToken;

// export const uploadToImgur = async (dalleUrl: string) => {
//   const response = await fetch("http://172.18.6.73:3000/upload-to-imgur", {
//     method: "POST",
